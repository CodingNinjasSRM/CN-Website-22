...
import style from './Nontechnical.module.css'
...
function Nontechnical() {
    return (
        ...
        <div className={`md:text-[84px] text-[35px] text-transparent bg-clip-text font-[800] md:pt-20 md:mt-10 mt-6 pt-20 ${style.corporateheading}`}>NON TECHNICAL</div>
        ...
        <div className='flex justify-center pb-20'>
            ...
            <Link to='/nontechnical'><img src={rightar} className='mx-10 md:mx-10'/></Link>
        </div>
    </div>
    )
}
