...
function Technical() {
    return (
        <div className={`${style.technicalbg}`}>
            <div className={`md:text-[84px] text-[35px] text-transparent bg-clip-text font-[800] md:pt-20 md:mt-10 mt-6 pt-20 ${style.technicalheading}`}>TECHNICAL</div>
            ...
            <div className='md:flex md:pb-10 justify-center'>
                <p className='md:text-left md:text-xl text-[15px] mx-auto font-light text-white px-16 pt-10 md:px-20 md:pt-10 md:mx-2 md:pb-0 pb-20'>This domain is the backbone of the club that needs certain ideation, technical skills and innovation. Members of this domain are the pillars of the team who work tirelessly to make it what it is today! Starting from the journey of  'HELLO WORLD' to creating a full website, this domain completes it all. So, fasten your seat belts for the technical fight.<p className='md:block hidden md:pt-10 pt-10 mt-5 md:mt-5'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi elementum et ante ac fringilla. Pellentesque et felis metus. Cras facilisis ullamcorper magna.
            ...
            <div className='flex justify-center pb-20'>
                <Link to='/'><img src={leftar} className='mx-10 md:mx-10'/></Link>
                <img src={middle} className='hidden md:block'/>
                <Link to='/corporate'><img src={rightar} className='mx-10 md:mx-10'/></Link>
            </div>
        </div>
    )
}
