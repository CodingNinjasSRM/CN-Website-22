...
function Technical() {
    return (
        <div className={`${style.technicalbg}`}>
            <div className={`md:text-7xl text-5xl text-transparent bg-clip-text font-extrabold md:pt-20 md:mt-12 mt-12 pt-10 ${style.technicalheading}`}>TECHNICAL</div>
            ...
            <div className='flex justify-center pb-20'>
                ...
                <img src={middle}/>
                <Link to='/corporate'><img src={rightar} className='mx-10'/></Link>
            </div>
        </div>
    )
}
