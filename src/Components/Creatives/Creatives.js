...
function Creatives() {
    return (
        ...
        <div className={`md:text-[84px] text-[35px] text-transparent bg-clip-text font-[800] md:pt-20 md:mt-10 mt-6 pt-20 ${style.creativeheading}`}>CREATIVES</div>
        ...
        <div className='flex justify-center pb-20'>
            <Link to='/corporate'><img src={leftar} className='mx-10 md:mx-10'/></Link>
            <img src={middle} className='hidden md:block'/>
            <Link to='/'><img src={rightar} className='mx-10 md:mx-10'/></Link>
        </div>
    </div>
    )
}
