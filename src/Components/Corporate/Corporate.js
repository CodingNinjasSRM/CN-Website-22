...
function Corporate() {
    return (
        <section className=''>
        <div className='md:text-7xl text-5xl text-transparent bg-clip-text bg-gradient-to-r from-orange-700 to-black md:text-left md:pl-20 font-extrabold  md:pt-20 pt-20 mt-10'>CORPORATE</div>
